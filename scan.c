...
/**
 * @fn chrpos
 * @brief Return the position of character c in string s, or -1 if c not found
 * @param s String to search
 * @param c Character to search for
 * @return Position of character c in string s, or -1 if c not found
 */
...
/**
 * @fn skip
 * @brief Skip past input that we don't need to deal with, i.e. whitespace, newlines. Return the first character we do need to deal with.
...
/**
 * @fn hexchar
 * @brief Read in a hexadecimal constant from the input
 * @return The hexadecimal constant
 */
...
/**
 * @fn scanch
 * @brief Return the next character from a character or string literal
...
/**
 * @fn scanint
 * @brief Scan and return an integer literal value from the input file.
...
/**
 * @fn scanstr
 * @brief Scan in a string literal from the input file, and store it in buf[]. Return the length of the string.
 * @param buf Buffer to store the string literal
...
/**
 * @fn scanident
 * @brief Scan an identifier from the input file and store it in buf[]. Return the identifier's length
 * @param c Character to scan
 * @param buf Buffer to store the identifier
 * @param lim Length of the identifier
...
/**
 * @fn keyword
 * @brief Given a word from the input, return the matching keyword token number or 0 if it's not a keyword.
...
/**
 * @fn Tstring
 * @brief List of token strings, for debugging purposes
 */
char *Tstring[] = {
    "EOF", "=", "+=", "-=", "*=", "/=", "%=",
    "?", "||", "&&", "|", "^", "&",
...
/**
 * @fn scan
 * @brief Scan and return the next token found in the input. Return 1 if token valid, 0 if no tokens left.
