...
/**
 * @fn cgtextseg
 * @brief Switch to the text segment
 * @param void
 * @return void
 */
void cgtextseg()
...
/**
 * @fn cgdataseg
 * @brief Switch to the data segment
 * @param void
 * @return void
 */
void cgdataseg()
...
/**
 * @fn cgprimsize
 * @brief Given a scalar type value, return the size of the QBE type in bytes.
 * @param type Type
 * @return int
 */
...
/**
 * @fn cgalign
 * @brief Given a scalar type, an existing memory offset (which hasn't been allocated to anything yet) and a direction (1 is up, -1 is down), calculate and return a suitably aligned memory offset for this scalar type.
 * @param type Type
 * @param offset Offset
...
/**
 * @fn cgalloctemp
 * @brief Allocate a QBE temporary
 * @param void
 * @return int
 */
...
/**
 * @fn cgpreamble
 * @brief Print out the assembly preamble for one output file
...
/**
 * @fn cgpostamble
 * @brief Nothing to do for the end of a file
 * @param void
 * @return void
 */
void cgpostamble()
...
/**
 * @fn used_switch
 * @brief Boolean flag: has there been a switch statement in this function yet?
 * @param void
 * @return int
 */
...
/**
 * @fn cgfuncpostamble
 * @brief Print out a function postamble
 * @param sym Symbol
 * @return void
 */
...
/**
 * @fn cgloadint
 * @brief Load an integer literal value into a temporary
 * @param value Value
 * @param type Type
 * @return the number of the temporary
 */
...
/**
 * @fn cgloadvar
 * @brief Load a value from a variable into a temporary
 * @param sym Symbol
 * @param op Operation
 * @return the number of the temporary
 */
...
/**
 * @fn cgloadglobstr
 * @brief Given the label number of a global string, load its address into a new temporary
 * @param label
 * @return
 */
...
/**
 * @fn cgadd
 * @brief Add two temporaries together
 * @param r1
 * @param r2
 * @param type
...
/**
 * @fn cgsub
 * @brief Subtract the second temporary from the first
 * @param r1
 * @param r2
 * @param type
 * @return the number of the temporary with the result
...
/**
 * @fn cgmul
 * @brief Multiply two temporaries together
 * @param r1
 * @param r2
 * @param type
 * @return the number of the temporary with the result
...
/**
 * @fn cgdivmod
 * @brief Divide or modulo the first temporary by the second
 * @param r1
 * @param r2
 * @param op
 * @param type
...
/**
 * @fn cgand
 * @brief Bitwise AND two temporaries
 * @param r1
 * @param r2
 * @param type
 * @return
...
/**
 * @fn cgor
 * @brief Bitwise OR two temporaries
 * @param r1
 * @param r2
 * @param type
 * @return
...
/**
 * @fn cgxor
 * @brief Bitwise XOR two temporaries
 * @param r1
 * @param r2
 * @param type
 * @return
...
/**
 * @fn cgshl
 * @brief Shift left r1 by r2 bits
 * @param r1
 * @param r2
 * @param type
 * @return
...
/**
 * @fn cgshr
 * @brief Shift right r1 by r2 bits
 * @param r1
 * @param r2
 * @param type
 * @return
...
/**
 * @fn cgnegate
 * @brief Negate a temporary's value
 * @param r
 * @param type
 * @return
 */
...
/**
 * @fn cginvert
 * @brief Invert a temporary's value
 * @param r
 * @param type
 * @return
 */
...
/**
 * @fn cglognot
 * @brief Logically negate a temporary's value
 * @param r
 * @param type
 * @return
 */
...
/**
 * @fn cgloadboolean
 * @brief Load a boolean value (only 0 or 1) into the given temporary
 * @param r
 * @param val
 * @param type
 */
...
/**
 * @fn cgboolean
 * @brief Convert an integer value to a boolean value. Jump if it's an IF, WHILE, LOGAND or LOGOR operation
 * @param r
 * @param op
 * @param label
 * @param type
 ...
 * @param arglist
 * @param typelist
 * @return Return the temprary with the result
 */
...
/**
 * @fn cgshlconst
 * @brief Shift a temporary left by a constant.
 * @param r
 * @param val
 * @param type
 * @return
...
/**
 * @fn cgstorglob
 * @brief Store a temporary's value into a global variable
 * @param r
 * @param sym
 * @return
 */
...
/**
 * @fn cgstorlocal
 * @brief Store a temporary's value into a local variable
 * @param r
 * @param sym
 * @return
 */
...
/**
 * @fn cgglobstr
 * @brief Generate a global string and its label.
 * @param l
 * @param strvalue
 * @param append
 * @return
...
/**
 * @fn cgglobstrend
 * @brief NUL terminate a global string
 * @return
 */
...
// Return the temporary number for the result.
/**
 * @fn cgcompare_and_set
 * @brief Compare two temporaries and set if true.
 * @param ASTop
 * @param r1
 * @param r2
 * @param type
 * @return Return the temporary number for the result.
 */
...
/**
 * @fn cgcompare_and_jump
 * @brief Compare two temporaries and jump if false.
 * @param ASTop
 * @param r1
 * @param r2
 * @param label
...
/**
 * @fn cgwiden
 * @brief Widen the value in the temporary from the old to the new type, a
 * @param r
 * @param oldtype
 * @param newtype
 * @return Return a temporary with this new value
 */
...
/**
 * @fn cgaddress
 * @brief Generate code to load the address of an identifier.
 * @param sym
 * @return Return a new temporary
 */
...
/**
 * @fn cgderef
 * @brief Dereference a pointer to get the value it points at into a new temporary
 * @param r
 * @param type
 * @return Return the temporary number for the result.
 */
...
/**
 * @fn cgmove
 * @brief Move value between temporaries
 * @param r1
 * @param r2
 * @param type
 * @return
...
/**
 * @fn cglinenum
 * @brief Output a gdb directive to say on which source code line number the following assembly code came from
 * @param line
 * @return
 */
...
/**
 * @fn cgcast
 * @brief Change a temporary value from its old type to a new type.
 * @param t
 * @param oldtype
 * @param newtype
 * @return Return a temporary with this new value
